...
let s:overrides = get(g:, "onedarker_color_overrides", {})
...
let s:colors = {
      ...
      \ "cursor_grey": get(s:overrides, "cursor_grey", { "gui": "#191B21", "cterm": "236", "cterm16": "8" }),
      \ "visual_grey": get(s:overrides, "visual_grey", { "gui": "#272B33", "cterm": "237", "cterm16": "15" }),
      \ "menu_grey": get(s:overrides, "menu_grey", { "gui": "#272B33", "cterm": "237", "cterm16": "8" }),
